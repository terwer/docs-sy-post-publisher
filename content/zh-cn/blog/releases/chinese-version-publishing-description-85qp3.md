---
title: 思源笔记发布工具v0-0-3发布
slug: chinese-version-publishing-description-85qp3
url: /post/chinese-version-publishing-description-85qp3.html
date: '2022-09-28 11:40:59'
tags:
  - 点击
  - 查看
  - 思源
...
categories:
  - zh-cn
  - blog
lastmod: '2023-01-08 19:56:47'
toc: true
keywords: 点击,查看,思源,笔记,发布,sy-p-003
description: >-
  将思源笔记的文章发布到支持的开放平台的思源笔记挂件目前支持vuepress以及种博客平台标准metaweblogapi和基于wordpress的xmlrpc远程调用api同时提供了一个统一通用的api适配器让适配任何平台成为可能。点击查看帮助文档点击查看配置视频教程最近更新点击这里查看开发进度关键特性发布feat_#标题支持数字编号例如在思源笔记的标题为利用pm后台运行nodejs程序发布的时候会自动去掉编号变成利用pm后台运行nodejs程序。这样做的目的是保持文章在思源笔记的结构化然后又不影响其他平台
isCJKLanguage: true
---
